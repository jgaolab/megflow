...
.. code-block:: bash
   ...
   mkdir -p /data/liaopan/datasets/megflow_multi_dataset_demo_3datasets/logs
   nextflow -log /data/liaopan/datasets/megflow_multi_dataset_demo_3datasets/logs/nextflow.log \
