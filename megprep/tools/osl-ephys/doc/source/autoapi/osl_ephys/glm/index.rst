:py:mod:`osl_ephys.glm`
=======================

.. py:module:: osl_ephys.glm
...
.. toctree::
   ...
   glm_base/index.rst
   glm_epochs/index.rst
   glm_spectrum/index.rst
...
.. autoapisummary::
   ...
   osl_ephys.glm.GLMBaseResult
   osl_ephys.glm.GroupGLMBaseResult
   osl_ephys.glm.SensorClusterPerm
   osl_ephys.glm.SensorMaxStatPerm
   osl_ephys.glm.SensorGLMSpectrum
   osl_ephys.glm.GroupSensorGLMSpectrum
   osl_ephys.glm.MaxStatPermuteGLMSpectrum
   osl_ephys.glm.ClusterPermuteGLMSpectrum
   osl_ephys.glm.GLMBaseResult
   osl_ephys.glm.GroupGLMBaseResult
   osl_ephys.glm.SensorClusterPerm
   osl_ephys.glm.GLMEpochsResult
   osl_ephys.glm.GroupGLMEpochs
...
.. autoapisummary::
   ...
   osl_ephys.glm.group_glm_spectrum
   osl_ephys.glm.glm_spectrum
   osl_ephys.glm.glm_irasa
   osl_ephys.glm.read_glm_spectrum
   osl_ephys.glm.plot_joint_spectrum_clusters
   osl_ephys.glm.plot_source_topo
   osl_ephys.glm.plot_joint_spectrum
   osl_ephys.glm.plot_sensor_spectrum
   osl_ephys.glm.plot_sensor_proj
   osl_ephys.glm.plot_sensor_data
   osl_ephys.glm.prep_scaled_freq
   osl_ephys.glm.get_source_colors
   osl_ephys.glm.get_mne_sensor_cols
   osl_ephys.glm.plot_channel_layout
   osl_ephys.glm.plot_with_cols
   osl_ephys.glm.decorate_spectrum
   osl_ephys.glm.glm_epochs
   osl_ephys.glm.group_glm_epochs
   osl_ephys.glm.read_mne_epochs
   osl_ephys.glm.read_glm_epochs
