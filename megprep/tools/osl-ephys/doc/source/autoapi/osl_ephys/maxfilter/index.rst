:py:mod:`osl_ephys.maxfilter`
=============================

.. py:module:: osl_ephys.maxfilter
...
.. autoapisummary::
   ...
   osl_ephys.maxfilter.validate_outdir
   osl_ephys.maxfilter.add_subdir
   osl_ephys.maxfilter.process_file_inputs
   osl_ephys.maxfilter._add_headpos
   osl_ephys.maxfilter._add_movecomp
   osl_ephys.maxfilter._add_movecompinter
   osl_ephys.maxfilter._add_hpie
   osl_ephys.maxfilter._add_hpig
   osl_ephys.maxfilter._add_hpisubt
   osl_ephys.maxfilter._add_autobad
   osl_ephys.maxfilter._add_autobad_dur
   osl_ephys.maxfilter._add_badlimit
   osl_ephys.maxfilter._add_bad
   osl_ephys.maxfilter._add_linefreq
   osl_ephys.maxfilter._add_tsss
   osl_ephys.maxfilter._add_trans
   osl_ephys.maxfilter._add_force
   osl_ephys.maxfilter._add_inorder
   osl_ephys.maxfilter._add_outorder
   osl_ephys.maxfilter._add_ctc
   osl_ephys.maxfilter._add_cal
   osl_ephys.maxfilter._add_origin
   osl_ephys.maxfilter._add_frame
   osl_ephys.maxfilter._add_scanner
   osl_ephys.maxfilter.quick_load_dig
   osl_ephys.maxfilter.fit_cbu_origin
   osl_ephys.maxfilter.run_maxfilter
   osl_ephys.maxfilter.run_multistage_maxfilter
   osl_ephys.maxfilter.run_cbu_3stage_maxfilter
   osl_ephys.maxfilter.run_maxfilter_batch
   osl_ephys.maxfilter.main
...
.. autoapisummary::
   ...
   osl_ephys.maxfilter.parser
   osl_ephys.maxfilter.osl_logger
   osl_ephys.maxfilter.__doc__
