:py:mod:`osl_ephys.source_recon.parcellation.parcellation`
==========================================================

.. py:module:: osl_ephys.source_recon.parcellation.parcellation
...
.. autoapisummary::
   ...
   osl_ephys.source_recon.parcellation.parcellation.load_parcellation
   osl_ephys.source_recon.parcellation.parcellation.find_file
   osl_ephys.source_recon.parcellation.parcellation.guess_parcellation
   osl_ephys.source_recon.parcellation.parcellation.parcellate_timeseries
   osl_ephys.source_recon.parcellation.parcellation._get_parcel_timeseries
   osl_ephys.source_recon.parcellation.parcellation.resample_parcellation
   osl_ephys.source_recon.parcellation.parcellation.symmetric_orthogonalise
   osl_ephys.source_recon.parcellation.parcellation.parcel_centers
   osl_ephys.source_recon.parcellation.parcellation.plot_parcellation
   osl_ephys.source_recon.parcellation.parcellation.plot_psd
   osl_ephys.source_recon.parcellation.parcellation.plot_correlation
   osl_ephys.source_recon.parcellation.parcellation._parcel_timeseries2nii
   osl_ephys.source_recon.parcellation.parcellation.convert2niftii
   osl_ephys.source_recon.parcellation.parcellation.convert2mne_raw
   osl_ephys.source_recon.parcellation.parcellation.convert2mne_epochs
   osl_ephys.source_recon.parcellation.parcellation.spatial_dist_adjacency
   osl_ephys.source_recon.parcellation.parcellation.parcel_vector_to_voxel_grid
